...
<div id="comments" class="comments-area"> <!-- comments-area -->
    ...
    <h2  class="comment-title">
        <?php  
            printf(
                esc_html(_nx('One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'UC-CMS_TeamProject')),
    ...
    ?>
        ...
        <p class="no-comments"><?php esc_html_e('Comments are closed', 'UC-CMS_TeamProject') ?></p>
    <?php
        endif;
    ?>
